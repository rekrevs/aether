...
1. **RG-flow irrelevance:** The **seed** operator \(\mathcal O\) has mass dimension \(\Delta>4\) (for \(d=4\)), making it **irrelevant**. We define the **normalized** operator \(O_S:=\mathcal O/\Lambda^{\Delta-4}\) so that \([O_S]=4\). At high energies/short distances:
   \[
