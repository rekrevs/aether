...
**Tidsfönster-notering:** Andra termen i (9.1), (D·min{1, η t/ħ}), växer linjärt för små tider (t ≪ ħ/η) och satureras till (D) för (t ≫ ħ/η). För typiska experimentella tidsskalor (t ~ 1–10³ s) och (η ~ 10^{-30}–10^{-28} J), ger detta (ħ/η ~ 10^{-5}–10^{-3} s), vilket innebär att S-bidraget kan bli märkbart på millisekund–sekund-skala men förblir begränsat till (D) (\ll 1) så länge (η ≪ ħv). Villkor (iv) garanterar (D·η/ħv ≪ 1) för alla relevanta (t), vilket gör bounden **giltig och konsistent för godtycklig experimentell tid**.
