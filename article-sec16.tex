...
\begin{enumerate}
  ...
  \item \textbf{Dimensionally consistent coupling law} (Sec.~6) for the substrate power $\Psig$, with clear separation between the similarity factor $K_\sigma$, the quality factor $Q$, and the pump-rate factor $\tilde K$.
