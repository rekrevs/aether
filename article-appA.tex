...
\begin{itemize}
  ...
  \[
    \alpha \equiv 1
  \]
  as shown in Sec.~3.2.2; there is no tunable ``reduced'' gravitational coupling for the $S$-sector.
  ...
  \item $\tilde K$: dimensionless pump-rate (or cost) factor, defined by
  \[
    \tilde K = \frac{P_{\mathrm{pump}}}{\hbar\omega_0} \quad [\mathrm{s}^{-1}],
  \]
