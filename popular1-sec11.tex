...
From our Lagrangian (3.1), with a preferred frame $\xi^\mu = (1, 0, 0, 0)$ in substrate rest, we get modifications to the \textbf{dispersion relation}:
...
\item $\lambda_C \sim 10^{-12}$ m (characteristic microscopic length of the photon-coupling chain, e.g., electronic Compton scale in cavity mirrors or material lattice constant; see article Appendix I for SME mapping)
...
\noindent\textbf{SME Connection: Why This Matters for Experiments}
