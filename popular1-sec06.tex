...
\begin{equation}
P_\sigma(e)
= \varepsilon\,K(e)\,\mathcal{Q}(e,t)\,\tilde{\Delta\Phi}(e)\,P_{\rm pump}(e) \quad (\text{units: W}).
\tag{6.1}
\end{equation}

\textbf{Unpacking the pieces:}

\textbf{$P_\sigma(e)$:} The power flowing through edge $e$ in pattern space
\begin{itemize}
...
\textbf{Unit check:}\\
$[P_\sigma] = 1 \times 1 \times 1 \times 1 \times W = W$ \checkmark

Everything balances. The flow $P_\sigma$ has units of power, as required.

\subsection{Alternative Formulation (Rate Form)}

For comparison, we can write:

$P_\sigma = \varepsilon \hbar\omega_0 K \mathcal{Q} \Krate \tilde{\Delta\Phi}$
...
As $V \to \infty$, $N \to \infty$, so $P_\sigma \to 0$.
