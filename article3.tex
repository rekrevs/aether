...
% Note: symbols and assumptions are input after \begin{document}
...
% Include symbols and assumptions tables here (after document begins)
...
This makes $\mathbb K(\sigma,\sigma')$ computable and controls nonlocality via $\lambda_\sigma$.
