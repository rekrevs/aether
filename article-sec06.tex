...
\begin{itemize}
  ...
  \item $\tilde{\Delta\Phi}(\tilde e)$ is a dimensionless free-energy increment associated with the driven transition on the corresponding macroscopic edge $\tilde e$ in $M$;
