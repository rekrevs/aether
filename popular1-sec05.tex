...
\begin{tcolorbox}[colback=green!5!white,colframe=green!75!black,title=\textbf{Why Colliders Don't See It: RG Flow in Plain English}]
...
\item \textbf{Relevant operators} ($\Delta < 4$): Get \emph{stronger} at low energies
  \begin{itemize}
  \item Example: mass terms
  \item Important for everyday physics
  \end{itemize}
\item \textbf{Marginal operators} ($\Delta = 4$): Stay roughly constant
  \begin{itemize}
  \item Example: electromagnetic coupling
  \end{itemize}
\item \textbf{Irrelevant operators} ($\Delta > 4$): Get \emph{weaker} at low energies, \emph{stronger} at high energies
  \begin{itemize}
  \item Our $O_S$ is dimension 6 or higher
  \item Dominates only at ultra-high energies (beyond accelerator reach)
  \end{itemize}
\end{itemize}
