...
\begin{equation}
R_{bit} \leq \eta \, \frac{P_{pump}}{k_B T \ln 2} \, \mathcal{Q} \, e^{-d_\sigma/\lambda_\sigma}, \qquad 0 < \eta \leq 1.
\tag{8.3}
\end{equation}
