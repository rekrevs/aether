...
\begin{tcolorbox}[colback=orange!5!white,colframe=orange!75!black,title=\textbf{Worked Example: Bitrate Calculation Arithmetic}]
...
\item Efficiency: $\eta = 0.1$ (10\% of pump power goes to information transfer)
...
Using equation (8.3):
\begin{align*}
R_{\rm bit} &\leq \eta \times R_{\rm max} \times \mathcal{Q} \times \Ksig \\
