...
\begin{itemize}
\item Standard relativity: $E^2 = (pc)^2 + (mc^2)^2$
\item Modified: $E^2 = (pc)^2 + (mc^2)^2 +$ corrections
\end{itemize}

\textbf{The correction $\delta$:}
\begin{itemize}
...
$J_\sigma \sim \varepsilon \hbar\omega_0 K \mathcal{Q} \Krate \tilde{\Delta\Phi}$
...
\begin{equation}
A \equiv A_{\rm sid}^{(\rm mat)} \;\simeq\; \varepsilon_{\rm mat}\,\Big(\frac{\lambda_\sigma}{L_{\rm exp}}\Big)\,\mathcal{Q}_{\rm mat}\,\Xi,
\tag{12.4}
\end{equation}
...
The bounds in \S11.1 constrain $\varepsilon_\gamma \mathcal{Q}_\gamma$ (optics). They don't directly bind (12.4) - see Appendix F for sector separation.
...
\textbf{What we'd see:}
\begin{itemize}
\item Energy transfer $J_\sigma$ varies sinusoidally
