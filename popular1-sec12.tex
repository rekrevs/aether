...
\begin{equation}
  A_{\rm sid}^{(\mathrm{mat})} \;\simeq\; \varepsilon_{\mathrm{mat}}
\left(\frac{\lambda_\sigma}{L_{\rm exp}}\right)\mathcal Q_{\mathrm{mat}}\;\Xi .
  \tag{12.4a}
\end{equation}

and \textbf{in the photon sector}:

\begin{equation}
  A_{\rm sid}^{(\gamma)} \;\simeq\; \varepsilon_{\gamma}
\left(\frac{\lambda_\sigma}{L_{\rm exp}}\right)\mathcal Q_{\gamma}\;\Xi .
  \tag{12.4b}
\end{equation}

\textbf{Important distinction:}\\
The matter sector (12.4a) uses ($\varepsilon_{mat}$, $\mathcal{Q}_{mat}$) as opposed to the \textbf{optical sector} (12.4b) with ($\varepsilon_\gamma$, $\mathcal{Q}_\gamma$) tested by Michelson-Morley type experiments.

The bounds in \S11 (Eq. 11.4) constrain $\varepsilon_\gamma \mathcal{Q}_\gamma$ (optics). They don't directly bind (12.4a) in the matter sector - see discussion of sector separation.
