...
\end{itemize}
Equation~(I.2) should be understood as a scaling relation; precise numerical factors depend on the detailed implementation of $O_S$ and the experimental geometry.
