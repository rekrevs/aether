...
Appendix~E collects the structural assumptions (A1)--(A9) used in the
...
factor $Q$ to zero in the thermodynamic limit.  Appendix~J gives an
...
\begin{itemize}
  \item each microscopic update that changes the $S$--state dissipates
        at least $k_BT\ln 2$ of entropy per bit of information, in the
