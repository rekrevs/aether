...
Under the technical assumptions listed in Appendix~C (bounded operator norms, finite propagation speed $c_S$ in $S$, exponential kernel decay with rate $\mu$, and weak coupling $\eta$ such that $\mu>\ln g$), one can prove the following modified bound.
